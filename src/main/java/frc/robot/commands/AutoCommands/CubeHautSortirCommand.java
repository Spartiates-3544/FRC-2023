...
public class CubeHautSortirCommand extends SequentialCommandGroup {
    String[] path = {"/home/lvuser/deploy/paths/AutonomeReculer.json"};
    public CubeHautSortirCommand(DrivetrainSubsystem drivetrain, ArmSubsystem arm, TurretSubsystem turret, ManipulatorSubsystem manipulator) {
        addCommands(
            new SetArmPositionCommand(arm, 200, 2868).withTimeout(1),
            new SetTurretPositionCommand(turret, 229028),
            new SetStage1Command(arm, 2513),
            Commands.waitSeconds(0.5),
            new SetStage2Command(arm, 1451),
