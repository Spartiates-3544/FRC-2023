...
public class RunPathCommand extends CommandBase {
 ...
 int currentRecordingIndex;
   ...
   */
  public RunPathCommand(DrivetrainSubsystem drivetrain, String[] path_to_run) {
  ...
  public void execute() {
    if (reader != null) {
      ...
      SmartDashboard.putNumber("x current", (Double) current.get("v"));
      m_drivetrain.arcadeDrive((Double) current.get("v"), (Double) current.get("omega"));
